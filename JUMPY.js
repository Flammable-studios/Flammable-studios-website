...
//sets up the Jumpy text jumping
function textJump() {
    tY += tYVelocity
    tYVelocity += 1
    if (tYVelocity < 11) {
...
function draw() {
    ...
    if (start == 1) {
        ...
        if (win == 1) {
            ...
            textSize(40)
            if (dP2 == 0) {
                text("Player 2 Wins!", 180, 170)
                textSize(20)
                text("Final Level: " + finalLevel, 255, 200)
                if (coinOn == 1) {
                    text("Final Score: " + finalScore, 255, 220)
                } else {
                }
                if (coinOn == 1) {
                    text("Press 'r' to Reset", 240, 240)
                } else if (coinOn == 0) {
        ...
        if (evilX > pX && evilX < pX + 40 && pY > 300 && dP1 == 0) {
            win = 1
            evilMult = 0
            evilMult2 = 0
            evilMult3 = 0
            ...
            finalLevel = level
            pX2 = 290
        } else if (evilX > pX2 && evilX < pX2 + 40 && pY2 > 300 && dP2 == 0) {
            win = 2
            evilMult = 0
            evilMult2 = 0
            evilMult3 = 0
        ...
        if (level > 49) {
            if (evilX2 > pX && evilX2 < pX + 40 && pY > 300 && dP1 == 0) {
                win = 1
                evilMult = 0
                evilMult2 = 0
                evilMult3 = 0
                ...
                finalLevel = level
                pX2 = 290
            } else if (evilX2 > pX2 && evilX2 < pX2 + 40 && pY2 > 300 && dP2 == 0) {
                win = 2
                evilMult = 0
                evilMult2 = 0
                evilMult3 = 0
        ...
        if (evilX3 + 30 > pX && evilX3 < pX + 40 && evilY3 + 60 > pY && evilY3 < pY + 40 && dP1 == 0) {
            win = 1
            evilMult = 0
            evilMult2 = 0
            evilMult3 = 0
            ...
            finalLevel = level
            pX2 = 290
        } else if (evilX3 + 30 > pX2 && evilX3 < pX2 + 40 && evilY3 + 60 > pY2 && evilY3 < pY2 + 40 && dP2 == 0) {
            win = 2
            evilMult = 0
            evilMult2 = 0
            evilMult3 = 0
        ...
        if (pX < coinX + 10 && pX + 30 > coinX - 10) {
            if (pY + 40 > coinY - 10 && pY < coinY + 10) {
                countAllow = 1
                frameCounter = 0
                score += 1
                coinX = random(50, 550)
        ...
        if (pX2 < coinX + 10 && pX2 + 30 > coinX - 10) {
            if (pY2 + 40 > coinY - 10 && pY2 < coinY + 10) {
                countAllow = 1
                frameCounter = 0
                score += 1
                coinX = random(50, 550)
        ...
        if (frameCount > 119 && win < 1 && coinOn == 1) {
            coin(coinX, coinY);
        }
...
function keyPressed() {
    ...
    if (keyIsPressed && keyCode == 87 && repeat2 == 0) {
        jump2()
    }


    if (keyIsPressed && keyCode == UP_ARROW && repeat3 == 0) {
        jump3()
    }


    if (keyIsPressed && keyCode == 32 && tRepeat == 0) {
        textJump()
    }
